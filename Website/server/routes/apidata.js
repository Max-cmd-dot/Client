...
router.get("/All/temperature", async (req, res) => {
  try {
    ...
    const data = await Data.find({ topic: "esp/air/temperature" }).sort({
      _id: -1,
    });
    if (data) return res.json(data);
  } catch (error) {
...
router.get("/All/humidity", async (req, res) => {
  try {
    ...
    const data = await Data.find({ topic: "esp/air/humidity" }).sort({
      _id: -1,
    });
    if (data) return res.json(data);
  } catch (error) {
...
router.get("/All/Lux", async (req, res) => {
  try {
    ...
    const data = await Data.find({ topic: "esp/ground/light/lux" }).sort({
      _id: -1,
    });
    if (data) return res.json(data);
  } catch (error) {
...
router.get("/All/moisture/1", async (req, res) => {
  try {
    ...
    const data = await Data.find({ topic: "esp/ground/moisture/1" }).sort({
      _id: -1,
    });
    if (data) return res.json(data);
  } catch (error) {
...
router.get("/All/moisture/2", async (req, res) => {
  try {
    ...
    const data = await Data.find({ topic: "esp/ground/moisture/2" }).sort({
      _id: -1,
    });
    if (data) return res.json(data);
  } catch (error) {
...
router.get("/All/moisture/3", async (req, res) => {
  try {
    ...
    const data = await Data.find({ topic: "esp/ground/moisture/3" }).sort({
      _id: -1,
    });
    if (data) return res.json(data);
  } catch (error) {
