  ...
  return (
    <div>
      ...
      <div>
        ...
        <h3>Shopify</h3>{" "}
        <p>
          Anbieter ist die Shopify International Limited, Victoria Buildings,
          1-2 Haddington Road, Dublin 4, D04 XN32, Irland (nachfolgend
          &bdquo;Shopify&ldquo;).
        </p>{" "}
        <p>
          Shopify ist ein Tool zum Erstellen und zum Hosten von Webseiten. Wenn
          Sie unsere Website besuchen, erfasst Shopify Ihre IP-Adresse sowie
          Informationen &uuml;ber das von Ihnen verwendete Endger&auml;t und
          Ihren Browser. Mit Shopify werden ferner die Besucherzahlen, die
          Besucherquellen das und Kundenverhalten analysiert sowie
          Nutzerstatistiken erstellt. Wenn Sie einen Kauf auf unserer Website
          t&auml;tigen, erfasst Shopify au&szlig;erdem Ihren Namen, Ihre
          E-Mail-Adresse, Liefer- und Rechnungsadressen, Zahlungsdaten und
          sonstige Daten, die mit dem Kauf in Zusammenhang stehen (z.&nbsp;B.
          Telefonnummer, H&ouml;he der get&auml;tigten Ums&auml;tze u.&Auml;.).
          F&uuml;r die Analysen speichert Shopify Cookies in Ihrem Browser.
        </p>{" "}
        <p>
          Details entnehmen Sie der Datenschutzerkl&auml;rung von Shopify:{" "}
          <a
        ...
        <p>
          Die Verwendung von Shopify erfolgt auf Grundlage von Art. 6 Abs. 1
